    ...
    public class WordsController : ControllerBase
    {
        ...
        public async Task<ActionResult<IEnumerable<Word>>> GetWord()
        {
          if (_context.Word == null)
          {
            ...
            return await _context.Word.Include(x => x.Lesson).ToListAsync();
        }
        ...
        public async Task<ActionResult<Word>> GetWord(int id)
        {
          if (_context.Word == null)
          {
            ...
            var word = await _context.Word.Include(x => x.Lesson).FirstOrDefaultAsync(x => x.Id == id);
        ...
        public async Task<ActionResult<Word>> PostWord(Word word)
        {
          if (_context.Word == null)
          {
              return Problem("Entity set 'E_SpeakingContext.Word'  is null.");
          }
